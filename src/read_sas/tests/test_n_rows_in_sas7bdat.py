...
def test_n_rows_in_sas7bdat_valid_inputs(
    mock_read_sas7bdat, mock_meta, filepath, column_list, expected_rows, capsys
):
    ...
    filepath = _format_filepath(Path(filepath))
...
def test_n_rows_in_sas7bdat_file_not_found(mock_read_sas7bdat, filepath, column_list):
...
def test_n_rows_in_sas7bdat_invalid_column(mock_read_sas7bdat, filepath, column_list):
